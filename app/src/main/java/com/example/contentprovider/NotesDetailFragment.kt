...
class NotesDetailFragment : DialogFragment(), DialogInterface.OnClickListener {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        if (arguments != null && arguments?.getLong(EXTRA_ID) != 0L) {
            ...
            //contentResolver se comunica com o Content Provider
        ...
        return AlertDialog.Builder(activity as Activity).setTitle( if (newNote) "Nova Mensagem" else "Editar Mensagem").setView(view).setPositiveButton("Salvar", this).setNegativeButton("Cancelar", this).create()
    }
